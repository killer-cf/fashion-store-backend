...
describe('Activate product (e2e)', () => {
  ...
  test('[PATCH] /products/:productId/activate', async () => {
    ...
    expect(productOnDatabase?.status).toEqual('ACTIVE')
  })

  test('[PATCH] /products/:productId/activate (Unauthorized)', async () => {
    const admin = await adminFactory.makePrismaAdmin({})
